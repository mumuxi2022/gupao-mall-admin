  ...
  export default {
    ...
    methods: {
      ...
      getAttrList(index, row) {
        this.$router.push({path: '/goods/productAttrList',query:{cid:row.id,cname:row.name,type:0}})
      },
      getParamList(index, row) {
        this.$router.push({path: '/goods/productAttrList',query:{cid:row.id,cname:row.name,type:1}})
      },
