...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addProductAttr() {
        this.$router.push({path:'/goods/addProductAttr',query:{cid:this.$route.query.cid,type:this.$route.query.type}});
      },
      ...
      handleUpdate(index, row) {
        this.$router.push({path:'/goods/updateProductAttr',query:{id:row.id}});
      },
